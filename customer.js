...
let bioHolder = document.getElementById("bio-holder")
let pinHolder = document.getElementById("pin-holder")
let pinBtn = document.getElementById("toggle-pin")
let bioBtn = document.getElementById("toggle-bio")
...
pinBtn.addEventListener("click", function() {
    ...
    if (pinHolder.style.display == "none" || bioHolder.style.display != "none") {

        pinHolder.style.display = "inline-block"
        bioHolder.style.display = "none"
...
bioBtn.addEventListener("click", function() {
    ...
    if (bioHolder.style.display == "none" || pinHolder.style.display != "none") {

        bioHolder.style.display = "flex"
        pinHolder.style.display = "none"
    }
})
